...
class Data_Manager(ABC):
    ...
    def __init__(self, sym, algo_case, operation_center):
        ...
        self.time_data_set_controller = self.time_data_set_manager.register_time_data_set_controller(self.get_global_generation_ID())#None#self.time_data_set_manager.register_time_data_set_controller(self.ID)
