...
class Data_Manager_Request_Bundler:
    ...
    def valdate_chosen_data_manager_bundle(self):
        ...
        for stock in self.chosen_stock_temp_container:
            if (stock.get_sym() == self.chosen_conditional_symbol1):
            ...
            if (stock.get_sym() == self.chosen_conditional_symbol2):
                if (chosen_stock_temp_container_index == 0):
                    conditional_dictionary[chosen_conditional_symbol1] = True
                if (chosen_stock_temp_container_index == 1):
                    conditional_dictionary[chosen_conditional_symbol2] = True
            ...
            if (stock.get_sym() == self.chosen_conditional_symbol3):
                if (chosen_stock_temp_container_index == 0):
                    conditional_dictionary[chosen_conditional_symbol1] = True
                if (chosen_stock_temp_container_index == 1):
                    conditional_dictionary[chosen_conditional_symbol2] = True
